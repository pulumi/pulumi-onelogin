...
import com.pulumi.onelogin.users.inputs.GetV1Filter;
...
public final class GetV1PlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetV1PlainArgs Empty = new GetV1PlainArgs();
    ...
    public Optional<List<GetV1Filter>> filters() {
    ...
    private GetV1PlainArgs() {}

    private GetV1PlainArgs(GetV1PlainArgs $) {
    ...
    public static Builder builder(GetV1PlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetV1PlainArgs defaults) {
            $ = new GetV1PlainArgs(Objects.requireNonNull(defaults));
        }
