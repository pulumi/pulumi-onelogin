...
@CustomType
public final class SamlAppsParameter {
    ...
    public static Builder builder(SamlAppsParameter defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String values;
        public Builder() {}
        public Builder(SamlAppsParameter defaults) {
        ...
        public Builder paramKeyName(String paramKeyName) {
            if (paramKeyName == null) {
              throw new MissingRequiredPropertyException("SamlAppsParameter", "paramKeyName");
            }
        ...
        public SamlAppsParameter build() {
            final var _resultValue = new SamlAppsParameter();
