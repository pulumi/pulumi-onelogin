...
public final class GetInstanceProvisioningArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public GetInstanceProvisioningArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetInstanceProvisioningArgs", "enabled");
            }
            if ($.status == null) {
                throw new MissingRequiredPropertyException("GetInstanceProvisioningArgs", "status");
            }
            return $;
        }
    }
