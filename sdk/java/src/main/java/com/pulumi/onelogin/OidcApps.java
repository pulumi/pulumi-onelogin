...
import com.pulumi.onelogin.inputs.OidcAppsState;
import com.pulumi.onelogin.outputs.OidcAppsParameter;
...
@ResourceType(type="onelogin:index/oidcApps:OidcApps")
public class OidcApps extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="parameters", refs={List.class,OidcAppsParameter.class}, tree="[0,1]")
    private Output<List<OidcAppsParameter>> parameters;

    public Output<List<OidcAppsParameter>> parameters() {
     ...
     */
    public OidcApps(java.lang.String name) {
        this(name, OidcAppsArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public OidcApps(java.lang.String name, OidcAppsArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public OidcApps(java.lang.String name, OidcAppsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("onelogin:index/oidcApps:OidcApps", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private OidcApps(java.lang.String name, Output<java.lang.String> id, @Nullable OidcAppsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("onelogin:index/oidcApps:OidcApps", name, state, makeResourceOptions(options, id), false);
    }

    private static OidcAppsArgs makeArgs(OidcAppsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? OidcAppsArgs.Empty : args;
    }
     ...
     */
    public static OidcApps get(java.lang.String name, Output<java.lang.String> id, @Nullable OidcAppsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
