...
public final class V1State extends com.pulumi.resources.ResourceArgs {

    public static final V1State Empty = new V1State();
    ...
    public static Builder builder(V1State defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(V1State defaults) {
            $ = new V1State(Objects.requireNonNull(defaults));
        }
