...
public final class V1Args extends com.pulumi.resources.ResourceArgs {

    public static final V1Args Empty = new V1Args();
    ...
    public static Builder builder(V1Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(V1Args defaults) {
            $ = new V1Args(Objects.requireNonNull(defaults));
        }
