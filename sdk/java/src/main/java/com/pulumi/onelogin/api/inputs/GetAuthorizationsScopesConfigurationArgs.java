...
public final class GetAuthorizationsScopesConfigurationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetAuthorizationsScopesConfigurationArgs Empty = new GetAuthorizationsScopesConfigurationArgs();
    ...
    private GetAuthorizationsScopesConfigurationArgs() {}

    private GetAuthorizationsScopesConfigurationArgs(GetAuthorizationsScopesConfigurationArgs $) {
    ...
    public static Builder builder(GetAuthorizationsScopesConfigurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetAuthorizationsScopesConfigurationArgs();
        }

        public Builder(GetAuthorizationsScopesConfigurationArgs defaults) {
            $ = new GetAuthorizationsScopesConfigurationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetAuthorizationsScopesConfigurationArgs build() {
