...
public final class GetV1InstanceArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetV1InstanceArgs Empty = new GetV1InstanceArgs();
    ...
    private GetV1InstanceArgs() {}

    private GetV1InstanceArgs(GetV1InstanceArgs $) {
    ...
    public static Builder builder(GetV1InstanceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetV1InstanceArgs();
        }

        public Builder(GetV1InstanceArgs defaults) {
            $ = new GetV1InstanceArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetV1InstanceArgs build() {
            if ($.id == null) {
                throw new MissingRequiredPropertyException("GetV1InstanceArgs", "id");
            }
            return $;
        }
    }
