...
@CustomType
public final class OidcAppsParameter {
    ...
    public static Builder builder(OidcAppsParameter defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String values;
        public Builder() {}
        public Builder(OidcAppsParameter defaults) {
        ...
        public Builder paramKeyName(String paramKeyName) {
            if (paramKeyName == null) {
              throw new MissingRequiredPropertyException("OidcAppsParameter", "paramKeyName");
            }
        ...
        public OidcAppsParameter build() {
            final var _resultValue = new OidcAppsParameter();
