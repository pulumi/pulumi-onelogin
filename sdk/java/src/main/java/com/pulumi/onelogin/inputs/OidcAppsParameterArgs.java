...
public final class OidcAppsParameterArgs extends com.pulumi.resources.ResourceArgs {

    public static final OidcAppsParameterArgs Empty = new OidcAppsParameterArgs();
    ...
    private OidcAppsParameterArgs() {}

    private OidcAppsParameterArgs(OidcAppsParameterArgs $) {
    ...
    public static Builder builder(OidcAppsParameterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OidcAppsParameterArgs();
        }

        public Builder(OidcAppsParameterArgs defaults) {
            $ = new OidcAppsParameterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public OidcAppsParameterArgs build() {
            if ($.paramKeyName == null) {
                throw new MissingRequiredPropertyException("OidcAppsParameterArgs", "paramKeyName");
            }
            return $;
        }
    }
