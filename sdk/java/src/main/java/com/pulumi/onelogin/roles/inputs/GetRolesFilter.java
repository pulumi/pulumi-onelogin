...
public final class GetRolesFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetRolesFilter Empty = new GetRolesFilter();
    ...
    private GetRolesFilter(GetRolesFilter $) {
        this.name = $.name;
        this.values = $.values;
    }
    ...
    public static final class Builder {
        ...
        public Builder(GetRolesFilter defaults) {
            $ = new GetRolesFilter(Objects.requireNonNull(defaults));
        }
