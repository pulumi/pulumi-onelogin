...
import com.pulumi.onelogin.users.inputs.GetV1FilterArgs;
...
public final class GetV1Args extends com.pulumi.resources.InvokeArgs {

    public static final GetV1Args Empty = new GetV1Args();
    ...
    @Import(name="filters")
    private @Nullable Output<List<GetV1FilterArgs>> filters;

    public Optional<Output<List<GetV1FilterArgs>>> filters() {
    ...
    public static Builder builder(GetV1Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetV1Args defaults) {
            $ = new GetV1Args(Objects.requireNonNull(defaults));
        }
        ...
        public Builder filters(@Nullable Output<List<GetV1FilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetV1FilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetV1FilterArgs... filters) {
