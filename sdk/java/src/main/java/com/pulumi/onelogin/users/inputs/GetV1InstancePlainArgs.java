...
public final class GetV1InstancePlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetV1InstancePlainArgs Empty = new GetV1InstancePlainArgs();
    ...
    private GetV1InstancePlainArgs() {}

    private GetV1InstancePlainArgs(GetV1InstancePlainArgs $) {
    ...
    public static Builder builder(GetV1InstancePlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetV1InstancePlainArgs();
        }

        public Builder(GetV1InstancePlainArgs defaults) {
            $ = new GetV1InstancePlainArgs(Objects.requireNonNull(defaults));
        }
