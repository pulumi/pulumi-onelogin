...
func GetUsers(ctx *pulumi.Context, args *GetUsersArgs, opts ...pulumi.InvokeOption) (*GetUsersResult, error) {
	...
	err := ctx.Invoke("onelogin:apps/getUsers:getUsers", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetUsersOutput(ctx *pulumi.Context, args GetUsersOutputArgs, opts ...pulumi.InvokeOption) GetUsersResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetUsersResultOutput, error) {
			...
			return ctx.InvokeOutput("onelogin:apps/getUsers:getUsers", args, GetUsersResultOutput{}, options).(GetUsersResultOutput), nil
...
func (o GetUsersResultOutput) AppsId() pulumi.StringOutput {
	return o.ApplyT(func(v GetUsersResult) string { return v.AppsId }).(pulumi.StringOutput)
}
