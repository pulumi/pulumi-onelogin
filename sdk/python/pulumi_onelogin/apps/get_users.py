...
class GetUsersResult:
    ...
    """
    def __init__(__self__, activated_at=None, apps_id=None, comment=None, company=None, created_at=None, department=None, directory_id=None, distinguished_name=None, email=None, external_id=None, filters=None, firstname=None, group_id=None, id=None, invalid_login_attempts=None, invitation_sent_at=None, last_login=None, lastname=None, locked_until=None, manager_ad_id=None, manager_user_id=None, member_of=None, password=None, password_algorithm=None, password_changed_at=None, password_confirmation=None, phone=None, preferred_locale_code=None, role_ids=None, salt=None, samaccount_name=None, state=None, status=None, title=None, trusted_idp_id=None, updated_at=None, username=None, userprincipalname=None):
...
def get_users(activated_at: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('onelogin:apps/getUsers:getUsers', __args__, opts=opts, typ=GetUsersResult).value
