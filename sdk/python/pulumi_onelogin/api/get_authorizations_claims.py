...
__all__ = [
    'GetAuthorizationsClaimsResult',
    'AwaitableGetAuthorizationsClaimsResult',
    'get_authorizations_claims',
    'get_authorizations_claims_output',
]

@pulumi.output_type
class GetAuthorizationsClaimsResult:
    """
    A collection of values returned by getAuthorizationsClaims.
    """
    def __init__(__self__, api_authorizations_id=None, attribute_transformations=None, default_values=None, filters=None, id=None, label=None, provisioned_entitlements=None, skip_if_blank=None, user_attribute_macros=None, user_attribute_mappings=None, values=None):
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetAuthorizationsClaimsFilterResult']]:
...
class AwaitableGetAuthorizationsClaimsResult(GetAuthorizationsClaimsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAuthorizationsClaimsResult(
...
def get_authorizations_claims(api_authorizations_id: Optional[str] = None,
                              ...
                              filters: Optional[Sequence[pulumi.InputType['GetAuthorizationsClaimsFilterArgs']]] = None,
                              ...
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAuthorizationsClaimsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('onelogin:api/getAuthorizationsClaims:getAuthorizationsClaims', __args__, opts=opts, typ=GetAuthorizationsClaimsResult).value

    return AwaitableGetAuthorizationsClaimsResult(
...
@_utilities.lift_output_func(get_authorizations_claims)
def get_authorizations_claims_output(api_authorizations_id: Optional[pulumi.Input[str]] = None,
                                     attribute_transformations: Optional[pulumi.Input[Optional[str]]] = None,
                                     default_values: Optional[pulumi.Input[Optional[str]]] = None,
                                     filters: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetAuthorizationsClaimsFilterArgs']]]]] = None,
                                     ...
                                     opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetAuthorizationsClaimsResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
