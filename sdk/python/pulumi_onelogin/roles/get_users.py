...
def get_users(activated_at: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('onelogin:roles/getUsers:getUsers', __args__, opts=opts, typ=GetUsersResult).value
