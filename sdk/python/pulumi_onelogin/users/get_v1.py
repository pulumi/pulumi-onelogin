...
def get_v1(activated_at: Optional[str] = None,
           ...
           filters: Optional[Sequence[Union['GetV1FilterArgs', 'GetV1FilterArgsDict']]] = None,
...
def get_v1_output(activated_at: Optional[pulumi.Input[Optional[str]]] = None,
                  ...
                  filters: Optional[pulumi.Input[Optional[Sequence[Union['GetV1FilterArgs', 'GetV1FilterArgsDict']]]]] = None,
    ...
    __args__['userprincipalname'] = userprincipalname
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('onelogin:users/getV1:getV1', __args__, opts=opts, typ=GetV1Result)
