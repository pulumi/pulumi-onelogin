...
class GetV1Result:
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetV1FilterResult']]:
...
def get_v1(activated_at: Optional[str] = None,
           ...
           filters: Optional[Sequence[pulumi.InputType['GetV1FilterArgs']]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('onelogin:users/getV1:getV1', __args__, opts=opts, typ=GetV1Result).value

    return AwaitableGetV1Result(
        activated_at=__ret__.activated_at,
        ...
        id=__ret__.id,
        invalid_login_attempts=__ret__.invalid_login_attempts,
        invitation_sent_at=__ret__.invitation_sent_at,
        last_login=__ret__.last_login,
        lastname=__ret__.lastname,
        locked_until=__ret__.locked_until,
        manager_ad_id=__ret__.manager_ad_id,
        manager_user_id=__ret__.manager_user_id,
        member_of=__ret__.member_of,
        password=__ret__.password,
        password_algorithm=__ret__.password_algorithm,
        password_changed_at=__ret__.password_changed_at,
        password_confirmation=__ret__.password_confirmation,
        phone=__ret__.phone,
...
@_utilities.lift_output_func(get_v1)
def get_v1_output(activated_at: Optional[pulumi.Input[Optional[str]]] = None,
                  ...
                  filters: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetV1FilterArgs']]]]] = None,
                  ...
                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetV1Result]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
