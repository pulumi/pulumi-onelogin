...
__all__ = [
    'GetV1InstanceResult',
    'AwaitableGetV1InstanceResult',
    'get_v1_instance',
    'get_v1_instance_output',
]

@pulumi.output_type
class GetV1InstanceResult:
    """
...
class AwaitableGetV1InstanceResult(GetV1InstanceResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetV1InstanceResult(
...
def get_v1_instance(activated_at: Optional[str] = None,
                    ...
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetV1InstanceResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('onelogin:users/getV1Instance:getV1Instance', __args__, opts=opts, typ=GetV1InstanceResult).value

    return AwaitableGetV1InstanceResult(
...
@_utilities.lift_output_func(get_v1_instance)
def get_v1_instance_output(activated_at: Optional[pulumi.Input[Optional[str]]] = None,
