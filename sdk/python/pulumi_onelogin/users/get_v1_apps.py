...
__all__ = [
    'GetV1AppsResult',
    'AwaitableGetV1AppsResult',
    'get_v1_apps',
    'get_v1_apps_output',
]

@pulumi.output_type
class GetV1AppsResult:
    """
    A collection of values returned by getV1Apps.
    """
    def __init__(__self__, extension=None, filters=None, icon_url=None, id=None, login_id=None, name=None, provisioning_enabled=None, provisioning_state=None, provisioning_status=None, users_v1_id=None):
        ...
        if users_v1_id and not isinstance(users_v1_id, str):
            raise TypeError("Expected argument 'users_v1_id' to be a str")
        pulumi.set(__self__, "users_v1_id", users_v1_id)
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetV1AppsFilterResult']]:
    ...
    @property
    @pulumi.getter(name="usersV1Id")
    def users_v1_id(self) -> str:
        return pulumi.get(self, "users_v1_id")


class AwaitableGetV1AppsResult(GetV1AppsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetV1AppsResult(
...
def get_v1_apps(extension: Optional[bool] = None,
                ...
                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetV1AppsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('onelogin:users/getV1Apps:getV1Apps', __args__, opts=opts, typ=GetV1AppsResult).value

    return AwaitableGetV1AppsResult(
        ...
        users_v1_id=pulumi.get(__ret__, 'users_v1_id'))
def get_v1_apps_output(extension: Optional[pulumi.Input[Optional[bool]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetV1AppsResult(
        ...
        users_v1_id=pulumi.get(__response__, 'users_v1_id')))
