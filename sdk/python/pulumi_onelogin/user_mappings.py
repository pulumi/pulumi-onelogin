...
class UserMappings(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 actions: Optional[pulumi.Input[Sequence[pulumi.Input[Union['UserMappingsActionArgs', 'UserMappingsActionArgsDict']]]]] = None,
                 conditions: Optional[pulumi.Input[Sequence[pulumi.Input[Union['UserMappingsConditionArgs', 'UserMappingsConditionArgsDict']]]]] = None,
                 enabled: Optional[pulumi.Input[bool]] = None,
                 match: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 position: Optional[pulumi.Input[int]] = None,
