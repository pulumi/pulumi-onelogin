...
{
    [OneloginResourceType("onelogin:users/v1:V1")]
    public partial class V1 : global::Pulumi.CustomResource
    {
        [Output("activatedAt")]
        ...
        public V1(string name, V1Args? args = null, CustomResourceOptions? options = null)
            : base("onelogin:users/v1:V1", name, args ?? new V1Args(), MakeResourceOptions(options, ""))
        {
        }

        private V1(string name, Input<string> id, V1State? state = null, CustomResourceOptions? options = null)
            : base("onelogin:users/v1:V1", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static V1 Get(string name, Input<string> id, V1State? state = null, CustomResourceOptions? options = null)
        {
            return new V1(name, id, state, options);
        }
    }

    public sealed class V1Args : global::Pulumi.ResourceArgs
    {
        [Input("activatedAt")]
        ...
        public static new V1Args Empty => new V1Args();
    }

    public sealed class V1State : global::Pulumi.ResourceArgs
    {
        [Input("activatedAt")]
        public Input<string>? ActivatedAt { get; set; }
        ...
        public static new V1State Empty => new V1State();
    }
}
