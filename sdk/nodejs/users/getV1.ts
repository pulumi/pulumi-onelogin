...
export function getV1(args?: GetV1Args, opts?: pulumi.InvokeOptions): Promise<GetV1Result> {
    args = args || {};

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("onelogin:users/getV1:getV1", {
...
export interface GetV1Args {
    ...
    email?: string;
    externalId?: string;
    filters?: inputs.users.GetV1Filter[];
    firstname?: string;
    groupId?: number;
...
export interface GetV1Result {
    ...
    readonly filters?: outputs.users.GetV1Filter[];
...
export function getV1Output(args?: GetV1OutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetV1Result> {
    return pulumi.output(args).apply((a: any) => getV1(a, opts))
}

/**
 * A collection of arguments for invoking getV1.
 */
export interface GetV1OutputArgs {
    ...
    filters?: pulumi.Input<pulumi.Input<inputs.users.GetV1FilterArgs>[]>;
