...
export class V1 extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: V1State, opts?: pulumi.CustomResourceOptions): V1 {
        return new V1(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'onelogin:users/v1:V1';

    /**
     * Returns true if the given object is an instance of V1.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is V1 {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === V1.__pulumiType;
    }
    ...
    /**
     * Create a V1 resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: V1Args, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: V1Args | V1State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as V1State | undefined;
            ...
            const args = argsOrState as V1Args | undefined;
        ...
        super(V1.__pulumiType, name, resourceInputs, opts);
    }
}
